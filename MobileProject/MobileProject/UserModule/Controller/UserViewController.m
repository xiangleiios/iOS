...
{
//    [FMShareHelper shareTextDataWithPlatform:FMSocialPlatformType_Sina withTextData:@"我是测试的内容" withCompletion:^(id result, NSError *error) {
//       if(error)
//       {
//           NSLog(@"分享出错了");
//       }
//    }];
    ...
    [FMShareHelper shareUrlDataWithPlatform:FMSocialPlatformType_WechatSession withShareUrl:@"http://www.sina.com.cn" withTitle:@"新浪" withDescr:@"新浪网页" withThumImage:@"http://dev.umeng.com/images/tab2_1.png" withCompletion:^(id result, NSError *error) {
        if(error)
        {
            NSLog(@"分享出错了");
        }
