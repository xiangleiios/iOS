...
{
    if (!_searchView) {
        self.searchView = [[LLSearchView alloc] initWithFrame:CGRectMake(0, 64, SCREEN_WIDTH, SCREEN_HEIGHT - 64) hotArray:self.hotArray historyArray:self.historyArray];
...
//    [self.navigationItem setHidesBackButton:YES];
    ...
    // 创建搜索框
    UIView *titleView = [[UIView alloc] initWithFrame:CGRectMake(5, 27, self.view.frame.size.width, 30)];
