...
- (UIView *)setViewWithOriginY:(CGFloat)riginY title:(NSString *)title textArr:(NSMutableArray *)textArr
{
    ...
    for (int i = 0; i < textArr.count; i++) {
        ...
        if (i % 2 == 0 && [title isEqualToString:@"热门搜索"]) {
            label.layer.borderColor = kColor_N(255, 148, 153).CGColor;
            label.textColor = kColor_N(255, 148, 153);
        } else {
            label.textColor = kColor_N(111, 111, 111);
            label.layer.borderColor = kColor_N(227, 227, 227).CGColor;
        }
