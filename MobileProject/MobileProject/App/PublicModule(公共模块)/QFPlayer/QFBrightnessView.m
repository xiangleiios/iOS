...
@implementation QFBrightnessView

+ (instancetype)sharedBrightnessView {
	static QFBrightnessView *instance;
	static dispatch_once_t onceToken;
	dispatch_once(&onceToken, ^{
		instance = [[QFBrightnessView alloc] init];
...
- (instancetype)init {
	if (self = [super init]) {
		...
		self.backImage = ({
            ...
            imgView.image        = [UIImage imageNamed:QFPlayerSrcName(@"playgesture_BrightnessSun6")];
