...
@implementation QFPlayerControlView
...
- (void)makeSubViewsConstraints
{
    ...
    [self.titleLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.left.mas_equalTo(40);//(CGRectGetMaxX(self.backBtn.frame)+10);
...
- (UIButton *)backBtn
{
    if (!_backBtn) {
        ...
        [_backBtn setImage:[UIImage imageNamed:@"fh@2x"] forState:UIControlStateNormal];
    }
    return _backBtn;
}
- (UILabel *)titleLabel
...
- (UIImageView *)topImageView
{
    if (!_topImageView) {
        ...
        _topImageView.image                  = [UIImage imageNamed:QFPlayerSrcName(@"top_shadow")];
    }
...
- (UIImageView *)bottomImageView
{
    if (!_bottomImageView) {
        ...
        _bottomImageView.image                  = [UIImage imageNamed:QFPlayerSrcName(@"bottom_shadow")];
    }
...
- (UIButton *)lockBtn
{
    if (!_lockBtn) {
        ...
        [_lockBtn setImage:[UIImage imageNamed:QFPlayerSrcName(@"unlock-nor")] forState:UIControlStateNormal];
        [_lockBtn setImage:[UIImage imageNamed:QFPlayerSrcName(@"lock-nor")] forState:UIControlStateSelected];
    }
    return _lockBtn;
}
...
- (UIButton *)startBtn
{
    if (!_startBtn) {
        ...
        [_startBtn setImage:[UIImage imageNamed:@"bofang-a"] forState:UIControlStateNormal];
        [_startBtn setImage:[UIImage imageNamed:@"anniuzant"] forState:UIControlStateSelected];
    }
    return _startBtn;
}
...
- (UISlider *)videoSlider
{
    if (!_videoSlider) {
        ...
        // 设置slider
        [_videoSlider setThumbImage:[UIImage imageNamed:QFPlayerSrcName(@"slider")] forState:UIControlStateNormal];
...
- (UIButton *)fullScreenBtn
{
    if (!_fullScreenBtn) {
        ...
        [_fullScreenBtn setImage:[UIImage imageNamed:@"quanping"] forState:UIControlStateNormal];
        [_fullScreenBtn setImage:[UIImage imageNamed:@"anniub"] forState:UIControlStateSelected];
    }
...
- (UILabel *)horizontalLabel
{
    if (!_horizontalLabel) {
        ...
        // 设置快进快退label
        _horizontalLabel.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:QFPlayerSrcName(@"Management_Mask")]];
    }
...
- (UIButton *)repeatBtn
{
    if (!_repeatBtn) {
        ...
        [_repeatBtn setImage:[UIImage imageNamed:QFPlayerSrcName(@"repeat_video")] forState:UIControlStateNormal];
    }
    return _repeatBtn;
}
...
- (UIButton *)downLoadBtn
{
    if (!_downLoadBtn) {
        ...
        [_downLoadBtn setImage:[UIImage imageNamed:QFPlayerSrcName(@"player_downLoad")] forState:UIControlStateNormal];
        [_downLoadBtn setImage:[UIImage imageNamed:QFPlayerSrcName(@"player_not_downLoad")] forState:UIControlStateDisabled];
    }
    return _downLoadBtn;
}
