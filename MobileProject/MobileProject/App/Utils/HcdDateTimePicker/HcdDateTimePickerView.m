...
#define kTopViewHeight kScaleFrom_iPhone5_H(44)
#define kTimeBroadcastViewHeight kScaleFrom_iPhone5_H(200)
...
- (void)showHcdDateTimePicker
{
    ...
    [UIView animateWithDuration:0.3f delay:0 usingSpringWithDamping:0.8f initialSpringVelocity:0 options:UIViewAnimationOptionLayoutSubviews animations:^{
        ...
        [timeBroadcastView setFrame:CGRectMake(0, kScreen_Height - kDatePickerHeight - kNavBarH, kScreen_Width, kDatePickerHeight)];
