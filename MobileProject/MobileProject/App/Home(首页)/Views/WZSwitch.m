...
-(instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _rightDownLable.text      = [NSString stringWithFormat:@"%ld年度",(year + 1)];
        _rightDownLable.textAlignment    = NSTextAlignmentCenter;
        _rightDownLable.textColor        = kColor_N(153, 153, 157);
        ...
        _leftOnLabel.text      = [NSString stringWithFormat:@"%ld年度",(long)year];
        _leftOnLabel.textAlignment    = NSTextAlignmentCenter;
        _leftOnLabel.textColor        = kColor_N(106, 196, 136);
        ...
        _rightOnLabel.text      = [NSString stringWithFormat:@"%ld年度",(year + 1)];
        _rightOnLabel.textAlignment    = NSTextAlignmentCenter;
        _rightOnLabel.textColor        = kColor_N(106, 196, 136);
        ...
        self.moveView.layer.borderColor = kColor_N(188, 188, 188).CGColor;
        ...
        self.layer.borderColor = kColor_N(236, 236, 236).CGColor;
