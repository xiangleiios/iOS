...
@interface MyPicturePosterListVC ()<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout>
@property (nonatomic , strong)NSMutableArray <FMMainModel *>*dataArr;
@property (nonatomic , assign)int pageNum;
@end

@implementation MyPicturePosterListVC
...
- (void)loadtable{
    ...
    [self.table registerClass:[MyPicturePosterCell class] forCellWithReuseIdentifier:@"MyPicturePosterCell"];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    MyPicturePosterCell *cell = (MyPicturePosterCell *)[collectionView dequeueReusableCellWithReuseIdentifier:@"MyPicturePosterCell" forIndexPath:indexPath];
