...
{
    _mainScrollView = [[UIScrollView alloc] initWithFrame:CGRectMake(0, self.buttonHeight + self.topToNav, MainScreenWidth, MainScreenHeight - self.buttonHeight - self.topToNav)];
    _mainScrollView.contentSize = CGSizeMake(MainScreenWidth * subViewControllers.count, MainScreenHeight - self.buttonHeight - self.topToNav);
...
- (UIColor *)bottomScreenLineColor
{
    if (_bottomScreenLineColor == nil) {
        _bottomScreenLineColor = [UIColor lightGrayColor];
    }
