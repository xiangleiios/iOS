...
@implementation FMMediator

+ (instancetype)sharedInstance {
  static FMMediator *mediator;
  static dispatch_once_t onceToken;
  dispatch_once(&onceToken, ^{
    mediator = [[FMMediator alloc] init];
  });
  return mediator;
}
...
/*
 ...
 url sample:
 fmScheme://targetA/actionB?id=1234
 */

- (id)performActionWithUrl:(NSURL *)url
                completion:(void (^)(NSDictionary *))completion {
  if (![url.scheme isEqualToString:@"fmScheme"]) {
