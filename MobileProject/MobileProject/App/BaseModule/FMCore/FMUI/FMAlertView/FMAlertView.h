...
UIKIT_EXTERN NSString *const FMAlertViewWillShowNotification;
UIKIT_EXTERN NSString *const FMAlertViewDidShowNotification;
UIKIT_EXTERN NSString *const FMAlertViewWillDismissNotification;
UIKIT_EXTERN NSString *const FMAlertViewDidDismissNotification;

typedef void(^clickHandle)(void);

typedef void(^clickHandleWithIndex)(NSInteger index);

typedef NS_ENUM(NSInteger, FMAlertViewButtonType) {
    FMAlertViewButtonTypeDefault = 0,
    FMAlertViewButtonTypeCancel,
    FMAlertViewButtonTypeWarn,
    FMAlertViewButtonTypeNone,
    FMAlertViewButtonTypeHeight
};
...
+ (void)showTwoButtonsWithTitle:(NSString *)title Message:(NSString *)message ButtonType:(FMAlertViewButtonType)buttonType ButtonTitle:(NSString *)buttonTitle Click:(clickHandle)click ButtonType:(FMAlertViewButtonType)buttonType ButtonTitle:(NSString *)buttonType Click:(clickHandle)click;
