...
@interface FMSearchBar()<UITextFieldDelegate>
{
    UITextField *_textField;
    UIImageView *_iconView;
    UIImageView *_iconCenterView;
    FMSearchBarIconAlign _iconAlignTemp;
}

@end


@implementation FMSearchBar
...
- (void)setIconAlign:(FMSearchBarIconAlign)iconAlign{
    if(!_iconAlignTemp){
...
- (void)ajustIconWith:(FMSearchBarIconAlign)iconAlign{
    if (_iconAlign == FMSearchBarIconAlignCenter) {
        ...
        if (!_iconCenterView) {
            _iconCenterView = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"FMSearchBar_ICON"]];
        ...
        [UIView animateWithDuration:1 animations:^{
            ...
            _iconView = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"FMSearchBar_ICON"]];
...
{
    if(_iconAlignTemp == FMSearchBarIconAlignCenter){
        self.iconAlign = FMSearchBarIconAlignLeft;
    }
...
{
    if(_iconAlignTemp == FMSearchBarIconAlignCenter){
        self.iconAlign = FMSearchBarIconAlignCenter;
    }
